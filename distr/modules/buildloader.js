define(["require", "exports", '../libs/buildstructs'], function(require, exports, build) {
    function readSectors(buf, numsectors) {
        var sectors = new Array(numsectors);
    ...
    function readWalls(buf, numwals) {
        var walls = new Array(numwals);
    ...
    function readSprites(buf, numsprites) {
