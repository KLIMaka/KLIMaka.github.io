...
define(["require", "exports", '../libs/mathutils'], function(require, exports, MU) {
    ...
    var TextureStub = (function () {
        ...
        TextureStub.prototype.get = function () {
            return null;
        };
        TextureStub.prototype.getWidth = function () {
            return this.w;
        };
        TextureStub.prototype.getHeight = function () {
            return this.h;
        };
        TextureStub.prototype.getFormat = function () {
            return null;
        };
        TextureStub.prototype.getType = function () {
            return null;
        };
        return TextureStub;
    })();
    ...
    var TextureImpl = (function () {
        function TextureImpl(width, height, gl, img, format, bpp) {
            if (typeof img === "undefined") { img = null; }
            if (typeof format === "undefined") { format = gl.RGBA; }
            if (typeof bpp === "undefined") { bpp = 4; }
    ...
    function createTexture(width, height, gl, img, format, bpp) {
        if (typeof img === "undefined") { img = null; }
        if (typeof format === "undefined") { format = gl.RGBA; }
        if (typeof bpp === "undefined") { bpp = 4; }
    ...
    var DrawTexture = (function (_super) {
        ...
        function DrawTexture(width, height, gl, img, format, bpp) {
            if (typeof img === "undefined") { img = null; }
            if (typeof format === "undefined") { format = gl.RGBA; }
            if (typeof bpp === "undefined") { bpp = 4; }
            _super.call(this, width, height, gl, img, format, bpp);
        }
    ...
    function createDrawTexture(width, height, gl, img, format, bpp) {
        if (typeof img === "undefined") { img = null; }
        if (typeof format === "undefined") { format = gl.RGBA; }
        if (typeof bpp === "undefined") { bpp = 4; }
