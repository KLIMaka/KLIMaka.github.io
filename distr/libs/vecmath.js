define(["require", "exports", '../libs_js/glmatrix', './pool', './mathutils'], function(require, exports, GLM, pool, MU) {
    ...
    function intersect2d(p1s, p1e, p2s, p2e) {
        var t = exports.intersect2dT(p1s, p1e, p2s, p2e);
        if (t == null)
            return null;
        return exports.lerpCopy2d(p1s, p2e, t);
    }
    ...
    function direction3d(ps, pe) {
        return exports.normalize3d(exports.subCopy3d(pe, ps));
    }
    exports.direction3d = direction3d;

    function direction2d(ps, pe) {
        return exports.normalize2d(exports.subCopy2d(pe, ps));
    }
    exports.direction2d = direction2d;

    function projectXY(p) {
        return exports.fromValues2d(p[0], p[1]);
    }
    exports.projectXY = projectXY;
    function projectXZ(p) {
        return exports.fromValues2d(p[0], p[2]);
    }
    exports.projectXZ = projectXZ;
    function projectYZ(p) {
        return exports.fromValues2d(p[1], p[2]);
    }
    exports.projectYZ = projectYZ;

    function intersect3d(p1s, p1e, p2s, p2e) {
        var dir1 = exports.direction3d(p1s, p1e);
        var dir2 = exports.direction3d(p2s, p2e);

        var p = (dir1[1] * dir2[0] - dir2[1] * dir1[0]) != 0 ? exports.projectXY : (dir1[0] * dir2[1] - dir2[0] * dir1[1]) != 0 ? exports.projectXZ : (dir1[1] * dir2[2] - dir2[1] * dir1[2]) != 0 ? exports.projectYZ : null;

        exports.release3d(dir1);
        exports.release3d(dir2);
        ...
        var p1e_ = p(p1e);
        var p2e_ = p(p2e);
        var t = exports.intersect2dT(p1s_, p1e_, p2s_, p2e_);
        exports.release2d(p1s_);
        exports.release2d(p2s_);
        exports.release2d(p1e_);
        exports.release2d(p2e_);

        if (t == null)
            return null;
        return exports.lerpCopy3d(p1s, p1e, t);
    }
    exports.intersect3d = intersect3d;

    function normal2d(v1, v2) {
        var tmp = exports.normalize2d(exports.subCopy2d(v2, v1));
        var norm = exports.fromValues2d(-tmp[1], tmp[0]);
        exports.release2d(tmp);
        return norm;
    }
    exports.normal2d = normal2d;

    function ang2d(p1, p2, p3) {
        var toNext = exports.subCopy2d(p3, p2);
        exports.normalize2d(toNext);
        var toPrev = exports.subCopy2d(p1, p2);
        exports.normalize2d(toPrev);
        ...
        exports.release2d(toNext);
        exports.release2d(toPrev);
    ...
    function isCW(polygon) {
        ...
        for (var i = 0; i < N; i++) {
            ...
            angsum += exports.ang2d(prev, curr, next);
        }
    ...
    function polygonNormal(verts) {
        var a = exports.subCopy3d(verts[1], verts[0]);
        var b = exports.subCopy3d(verts[2], verts[0]);
        var res = exports.normalize3d(exports.crossCopy3d(b, a));
        exports.release3d(a);
        exports.release3d(b);
        return res;
    }
    ...
    function findOther(vtxs, start, v1, v2) {
        var vec = exports.subCopy3d(vtxs[v1], vtxs[v2]);
        var len = vtxs.length;
        for (var i = 0; i < len; i++) {
            var v3 = MU.cyclic(start + i, len);
            var vec1 = exports.subCopy3d(vtxs[v1], vtxs[v3]);
            var d = exports.dot3d(vec1, vec) / (exports.len3d(vec) * exports.len3d(vec1));
            if (Math.abs(Math.abs(d) - 1.0) < MU.EPS)
                continue;
            exports.release3d(vec);
            exports.release3d(vec1);
            return v3;
        }
    }
    ...
    function findOrigin(vtxs) {
        ...
        for (var i = 0; i < len; i++) {
            ...
            var d = exports.subCopy3d(vi, vn);
            var dl = exports.len3d(d);
    ...
    function projectionSpace(vtxs) {
        ...
        var a = exports.subCopy3d(vtxs[o[1]], vtxs[o[2]]);
        var b = exports.subCopy3d(vtxs[o[1]], vtxs[o[0]]);
        var n = exports.normalize3d(exports.crossCopy3d(b, a));
        var c = exports.normalize3d(exports.crossCopy3d(n, a));
        exports.normalize3d(a);
        var ret = [
            a[0], c[0], n[0],
            a[1], c[1], n[1],
            a[2], c[2], n[2]
    ...
    function project3d(vtxs) {
        var mat = exports.projectionSpace(vtxs);
        var ret = [];
