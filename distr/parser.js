define(["require", "exports", './modules/lex/lexer', './modules/lex/parser', './libs/getter'], function(require, exports, __lex__, __pars__, __getter__) {
    var lex = __lex__;
    var pars = __pars__;
    ...
    var AND = function (rules) {
        return new pars.AndParserRule(rules);
    };
    var BIND = function (id, rule) {
        return new pars.BindingParserRule(id, rule);
    };
    var OR = function (rules) {
        return new pars.OrParserRule(rules);
    };
    var COUNT = function (rule, from, to) {
        return new pars.CountParserRule(rule, from, to);
    };
    var PLUS = function (rule) {
        return COUNT(rule, 1, 0);
    };
    var STAR = function (rule) {
        return COUNT(rule, 0, 0);
    };
    var MAY = function (rule) {
        return COUNT(rule, 0, 1);
    };
