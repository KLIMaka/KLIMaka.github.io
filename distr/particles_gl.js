define(["require", "exports", 'modules/particles', 'modules/gl', 'modules/meshbuilder', './modules/controller2d', './modules/shaders', './modules/batcher', './libs_js/glmatrix'], function(require, exports, P, GL, MB, C2D, SHADERS, BATCHER, GLM) {
    var MAX_SIZE = 1000;
